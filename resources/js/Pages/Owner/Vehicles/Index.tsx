            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/90 shadow-2xs">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <div className="inline-flex items-center p-1 bg-slate-100 rounded-xl border border-slate-200/70">
                        ...
                        >
                            <LuWrench className={`w-3 h-3 ${filter === 'maintenance' ? 'text-white' : 'text-amber-500'}`} />
                    ...
                    >
                        <LuPlus className="w-4 h-4 text-teal-100" />
            ...
            {filteredVehicles.length === 0 ? (
                <div className="bg-white rounded-3xl border border-slate-200 p-12 text-center shadow-xs">
                    <div className="w-16 h-16 bg-slate-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                        <LuPlus className="w-8 h-8 text-slate-400" />
                    </div>
                                    ...
                                    <div className="absolute inset-0 bg-slate-900 rounded-t-2xl overflow-hidden">
                                        {coverPhoto ? (
                                            ...
                                            <div className="w-full h-full flex flex-col items-center justify-center text-slate-400 bg-gradient-to-br from-slate-800 to-slate-900 p-4 text-center">
                                                <LuCar className="w-10 h-10 text-slate-500 mb-1.5" />
                                    ...
                                    <div className="absolute top-3 right-3 z-30">
                                        ...
                                        >
                                            {isUpdating ? (
                                                ...
                                                <LuWrench className="w-3.5 h-3.5 text-amber-100" />
                                            ) : (
                                                <span
                                            ...
                                            <>
                                                ...
                                                <div className="absolute right-0 top-full mt-1.5 w-56 bg-white rounded-2xl shadow-2xl border border-slate-200 py-1.5 z-50 text-xs animate-fadeIn">
                                                    ...
                                                    >
                                                        ...
                                                        {isActive && <LuCheck className="w-4 h-4 text-emerald-600 shrink-0" />}
                                                    </button>
                                                    ...
                                                    >
                                                        ...
                                                        {isMaintenance && <LuCheck className="w-4 h-4 text-amber-600 shrink-0" />}
                                                    </button>
                                                    ...
                                                    >
                                                        <div className="flex items-center gap-2">
                                                            <LuCirclePause className="w-4 h-4 text-slate-400 shrink-0" />
                                                            <div>
                                                        ...
                                                        {isInactive && <LuCheck className="w-4 h-4 text-slate-600 shrink-0" />}
                                                    </button>
                                                </div>
                                            </>
                                        )}
                                ...
                                <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-3.5">
                                    <div className="space-y-1.5">
                                        ...
                                        <p className="text-xs text-slate-500 flex items-center gap-1 font-medium">
                                            <LuMapPin className="w-3.5 h-3.5 text-teal-600 shrink-0" />
                                    ...
                                    {isMaintenance && (
                                        <div className="p-2.5 rounded-xl bg-amber-50 border border-amber-200 text-amber-900 text-xs flex items-center gap-2">
                                            <LuWrench className="w-4 h-4 text-amber-600 shrink-0" />
                                    ...
                                    <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-100 text-xs text-slate-600 font-medium">
                                        ...
                                        <div className="flex items-center gap-1.5 bg-slate-50 px-2.5 py-1.5 rounded-xl border border-slate-100/80">
                                            <LuStar className="w-3.5 h-3.5 text-amber-400 fill-amber-400 shrink-0" />
                                    ...
                                    <div className="flex items-center gap-2 pt-2.5 border-t border-slate-100">
                                        ...
                                        >
                                            <LuSettings className="w-4 h-4 text-teal-100" />
                                        ...
                                        {isActive ? (
                                            ...
                                            >
                                                <LuEye className="w-4 h-4 text-teal-700 group-hover/pov:scale-110 transition-transform" />
