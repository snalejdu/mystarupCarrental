            ...
            <div className="flex items-center gap-2 mb-6 bg-slate-950 p-2.5 rounded-xl border border-slate-800 overflow-x-auto">
                ...
                {['', 'pending', 'accepted', 'completed', 'declined'].map((s) => (
                    <button
                        ...
                        className={`min-h-[44px] px-3.5 sm:px-4 py-2 rounded-lg text-xs font-semibold uppercase shrink-0 inline-flex items-center justify-center transition-all ${
                            (filters.status || '') === s
                                ? 'glass-pill-active'
                                ...
                                bookings.data.map((b: any) => (
                                    <tr key={b.id} className="hover:bg-slate-900/60 transition-colors">
                                        ...
                                        <td className="py-4 px-3">
                                            ...
                                            {b.renter_email && (
                                                <span className="text-xs text-slate-400 block mt-0.5">{b.renter_email}</span>
                                            )}
                                        </td>
