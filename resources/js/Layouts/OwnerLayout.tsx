        ...
        <div className="flex flex-col h-full bg-white">
            ...
            <div className="p-4 border-b border-slate-100 space-y-3">
                <div className="flex items-center justify-between">
                    ...
                    {onClose && (
                        <button onClick={onClose} className="glass-btn-icon p-1.5 rounded-lg text-slate-500 hover:text-slate-800">
                            <X className="w-4 h-4" />
                        </button>
                    )}
                </div>
                ...
                <div className="flex items-center justify-between px-0.5 text-[11px] font-medium text-slate-500">
                    ...
                    <span className="text-[10px] font-semibold text-teal-800 bg-teal-50 px-2 py-0.5 rounded-full border border-teal-100">
                        Bohol Node
                    </span>
                </div>
                ...
                <Link
                    ...
                    className="flex items-center justify-center gap-2 w-full py-2.5 px-3 rounded-xl bg-teal-600 hover:bg-teal-700 active:scale-[0.98] text-white font-semibold text-xs shadow-xs hover:shadow-md transition-all group"
                >
            ...
            <div className="flex-1 overflow-y-auto px-3 py-3 space-y-4">
                    ...
                    <nav className="space-y-1">
                        {secondaryNavItems.map((item: any) => (
                            <Link
                                key={item.href}
                                href={item.href}
                                className="flex items-center justify-between px-3 py-2 rounded-xl text-xs font-medium text-slate-600 hover:bg-slate-100/80 hover:text-slate-900 transition-colors"
                            >
                                <div className="flex items-center gap-2.5">
                ...
                <div className="p-3 rounded-2xl border border-teal-100/90 bg-gradient-to-br from-teal-50/80 via-white to-emerald-50/40 shadow-2xs space-y-1.5">
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[11px] font-bold text-slate-900">Island Shield</span>
                    </div>
                    ...
                    <Link
                        href="/terms"
                        className="inline-flex items-center gap-1 text-[10px] font-bold text-teal-700 hover:text-teal-800"
                    >
            ...
            <div className="p-3 border-t border-slate-200/80 bg-slate-50/90 space-y-2.5">
                <div className="flex items-center gap-2.5 p-2 rounded-xl bg-white border border-slate-200/70 shadow-2xs">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-[9px] font-bold uppercase tracking-wider text-teal-800 bg-teal-100/70 px-1 py-0.5 rounded">Host</span>
                        </div>
                ...
                <div className="space-y-1">
                    <Link
                        ...
                        method="post"
                        as="button"
                        className="w-full flex items-center justify-center gap-2 px-3 py-2 text-xs font-semibold text-teal-800 bg-white hover:bg-teal-50 border border-teal-200/80 hover:border-teal-300 rounded-xl transition-all shadow-2xs group"
                    >
                    ...
                    <Link
                        ...
                        method="post"
                        as="button"
                        className="w-full flex items-center justify-center gap-1.5 px-3 py-1 text-xs font-semibold text-rose-600 hover:text-rose-700 hover:bg-rose-50/80 rounded-lg transition-colors group"
                    >
